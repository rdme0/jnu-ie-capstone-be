...
import jnu.ie.capstone.session.handler.KioskAiSessionBlockingHandler
...
class WebSocketConfig(
    ...
    private val blockingHandler: KioskAiSessionBlockingHandler
) : WebSocketConfigurer {
    ...
    override fun registerWebSocketHandlers(registry: WebSocketHandlerRegistry) {
        ...
        registry.addHandler(blockingHandler, "/bench/stores/{storeId}/websocket/kioskSession-blocking")
            .addInterceptors(authInterceptor, storeIdHandshakeInterceptor)
            .setAllowedOriginPatterns(*originsProperties.allowedFrontEndOrigins.toTypedArray())
    }
